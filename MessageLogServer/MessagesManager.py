...
if __name__ == "__main__":
	...
	since_message_id = '662d04a64e01e7a079a8cce1' # Предположим, что это идентификатор сообщения
	# messages_since_id = message_manager.get_messages_since_id("Test", since_message_id)
	messages_since_id = message_manager.get_messages_since_date("Test", datetime.now() - timedelta(hours=6))
