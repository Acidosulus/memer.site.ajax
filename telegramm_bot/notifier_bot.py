...
def start(message, res=False):
    ...
    item1 = types.InlineKeyboardButton("1", callback_data='button1')
    item2 = types.InlineKeyboardButton("2", callback_data='button2')
    item3 = types.InlineKeyboardButton("3", callback_data='button3')
    item4 = types.InlineKeyboardButton("4", callback_data='button4')
